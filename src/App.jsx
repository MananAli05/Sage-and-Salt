      ...
      <div className="order-modal">
        <div className="success-screen">
          ...
          <p className="success-msg" style={{marginTop:'0.75rem'}}>
            Thank you, <strong>{order.name}</strong>! Your order is confirmed.<br />
            We'll deliver to <strong>{order.address}, {order.city}</strong>.
          </p>
          <p className="success-msg">
            Payment: <strong>{order.payment === 'cash' ? 'Cash on Delivery' : 'Online Payment'}</strong><br />
            Total: <strong style={{color:'var(--accent)'}}>{fmt(order.total)}</strong>
          </p>
          <p style={{fontSize:'0.85rem', color:'var(--text-muted)', marginTop:'1rem'}}>
             Confirmation SMS Will Be Sent To Your Number Shortly.
          </p>
